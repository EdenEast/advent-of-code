...
for `Paper`, and `3` for `Scissors`) plus the score for the **outcome of the round** (0 if you lost, 3 if the round
...
needs to end: `X` means you need to lose, `Y` means you need to end the round in a draw, and `Z` means you need to
win. Good luck!"
